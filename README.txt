...
a persistence unit "INVENTARIO_SISEECPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "INVENTARIO_SISEEC\pom.xml":
...
artifact ("INVENTARIO_SISEEC.war") is already built. You can build
